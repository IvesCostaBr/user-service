...
class ConsumerService(object):
    ...
    def Heathcheck(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/Consumer.ConsumerService/Heathcheck',
    ...
    def GetConsumers(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Consumer.ConsumerService/GetConsumers',
    ...
    def GetCredentials(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Consumer.ConsumerService/GetCredentials',
    ...
    def GetProviders(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Consumer.ConsumerService/GetProviders',
    ...
    def GetJourney(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Consumer.ConsumerService/GetJourney',
